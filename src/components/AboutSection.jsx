...
export default function AboutSection() {
  ...
  // Auto cycle avatars if multiple are uploaded
  useEffect(() => {
    if (about.avatars && about.avatars.length > 1) {
      const interval = setInterval(() => {
        setCurrentSlide((prev) => (prev + 1) % about.avatars.length);
      }, 3000);
  ...
  const timelineData = about.timeline || [
    {
      ...
      company: "Freelance",
      type: "work",
      desc: "聚焦于全栈开发、AI 提效工具研发，以及尝试将中国传统文化与现代数字化 UI/UX 深度结合的跨界产品孵化。",
    },
    {
      year: "2023 - 2025",
      role: "高级全栈工程师",
      company: "智能工作流研发中心",
      type: "work",
      desc: "负责企业级大模型工作流及智能体平台的设计与落地，积累了基于 Coze、FastGPT 等框架定制智能助手的深度实战经验。",
    },
    {
      year: "2021 - 2023",
      role: "前端研发主管",
    ...
    <div className="about-section-container">
      ...
      <div className="about-grid">
        ...
        <div className="about-card-glass profile-info-card">
          <div className="avatar-glow-wrapper" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div className="avatar-frame" style={{ overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
              {(!about.avatars || about.avatars.length === 0) ? (
            ...
            {about.avatars && about.avatars.length > 1 && (
              <div className="avatar-carousel-dots" style={{ zIndex: 12 }}>
                {about.avatars.map((_, idx) => (
                  <span 
                    key={idx} 
                    className={`avatar-carousel-dot ${currentSlide === idx ? "active" : ""}`}
          ...
          <h3 className="profile-name" style={{ marginTop: about.avatars && about.avatars.length > 1 ? "16px" : "0" }}>{about.name || "Aohs"}</h3>
          <p className="profile-tagline">{about.tagline || "个人创意开发者"}</p>
          ...
          <div className="profile-contact-list">
            <div className="contact-item">
              ...
              <span>{about.email || "contact@aohs.dev"}</span>
            </div>
            <div className="contact-item">
              <Globe size={16} className="accent-purple" />
              <span>{about.github || "https://github.com/Aohs"}</span>
            </div>
          </div>
        </div>
      ...
      <div className="tech-toolbox-grid">
        ...
        <div className="toolbox-card-glass">
          ...
          <ul className="toolbox-list">
            ...
            <li><strong>数据库设计：</strong> 具备良好的关系型数据库设计思维，善于编写清晰、高效 SQL。</li>
          </ul>
        </div>
        ...
        <div className="toolbox-card-glass">
          ...
          <ul className="toolbox-list">
            <li><strong>现代 Web 前端：</strong> 采用 Vue 3 + Vite + Pinia 生态，追求组件化开发与极速加载。</li>
            <li><strong>全场景/跨平台：</strong> 拥抱新生态，探索 HarmonyOS（ArkTS） 开发、微信小程序等全场景落地。</li>
            <li><strong>设计理念：</strong> 崇尚极简主义与直觉设计，拒绝冗余，让界面回归内容本身。</li>
          </ul>
        </div>
        ...
        <div className="toolbox-card-glass">
          ...
          <ul className="toolbox-list text-left" style={{ margin: 0, padding: 0 }}>
            <p className="toolbox-intro-text" style={{ fontSize: "0.85rem", opacity: 0.8, marginBottom: "8px", borderBottom: "1px dashed rgba(255,255,255,0.1)", paddingBottom: "6px" }}>
              作为 AI 全力驱动时代的践行者，我深入探索 LLM 与实际工作流的结合：
            </p>
            <li style={{ listStyle: "none", marginBottom: "8px" }}><strong>AI 辅助编程：</strong> 熟练使用 AI 编程工具，探索“人机协同”的高效开发新范式。</li>
            <li style={{ listStyle: "none", marginBottom: "8px" }}><strong>Agent 平台搭建：</strong> 基于 Coze、FastGPT 等框架，定制开发面向特定场景的智能助手与自动化流。</li>
            <li style={{ listStyle: "none", marginBottom: "8px" }}><strong>提示词工程：</strong> 精通 Prompt Engineering，擅长通过结构化提示词为 AI 设定精准行为边界。</li>
          </ul>
        </div>
      </div>
      ...
      <div className="about-grid" style={{ marginTop: "28px" }}>
        ...
        <div className="about-card-glass">
          ...
          <ul className="details-bullet-list">
            <li>
              <strong>AI 驱动的工作流变革：</strong> 如何利用 AI Agent 重新定义开发与日常办公，实现“一人顶百人”。
            </li>
            <li>
              <strong>全栈开发实战笔记：</strong> 记录从 0 到 1 沉淀的前后端打通、多端适配、性能优化硬核技术文。
            </li>
            <li>
              <strong>独立变现与产品思考：</strong> 记录开发过程中的设计心得，及传统文化与数字产品结合的尝试。
            </li>
            <li>
        ...
        <div className="about-card-glass">
          ...
          <ul className="details-bullet-list">
            <li>
              <strong>拒绝上下文过载：</strong> 倾向于清晰、模块化的结构，甚至与 AI 交互都有严格规则，拒绝冗余。
            </li>
            <li>
              <strong>传统与现代的碰撞：</strong> 热衷于用现代化的 UI 视觉和 AI 技术去翻新传统文化元素。
            </li>
            <li>
              <strong>实用主义至上：</strong> 所有的技术最终都要落脚于“解决具体问题”，不盲目跟风。
            </li>
          </ul>
        </div>
      </div>
